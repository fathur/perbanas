        ...
        <div class="col-xs-12 col-md-9 main-content-pane">
            <div class="row">
                <div class="col-xs-12 section-title">
                    <h1><div></div><span><?php _e('Education','perbanas'); ?></span></h1>
                </div>
            </div>
                ...
                <div class="col-xs-12">
                    <div class="top-row">
                        <p class="text-right back-link">
                            <a href="<?php echo get_post_type_archive_link(get_post_type()); ?>"><span class="arrow hidden-xs hidden-sm">&lsaquo;</span> <?php _e('Back to Perbanas Corner','perbanas'); ?></a>
                        </p>
                        <h2><?php the_title(); ?></h2>
