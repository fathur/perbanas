...
//	});
	...
	$(document).on('change', '.js-wpcf-access-list-roles', function() {
		$('.js-wpcf-access-add-shortcode').prop('disabled',true);
		if ( $('.js-wpcf-access-list-roles:checked').length > 0 ){
			$('.js-wpcf-access-add-shortcode').prop('disabled',false);	
		}
	});
	...
	$(document).on('click', '.js-wpcf-new-cap-add', function(e) {
		var test_cap_name = /^[a-z1-9_]*$/.test($('#js-wpcf-new-cap-slug').val());
